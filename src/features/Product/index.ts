...
export { default as TransactionTypeSlice } from "./store/TransactionType/index";
export { default as MaterialSlice } from "./store/Material/index";
export { default as ProductSlice} from "./store/Product/index";
