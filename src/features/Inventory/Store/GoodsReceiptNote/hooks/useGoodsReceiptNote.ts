...
import { addOrUpdateGoodsReceiptNote, fetchGoodsReceiptNote, fetchGoodsReceiptNoteLine, removeGoodsReceiptNote } from "../action";
...
export const useGoodsReceiptNote = () => {
  ...
  const GoodsReceiptNoteLines = useSelector((state: RootState) => state.goodsReceiptNotes.GoodsReceiptNoteLine);
